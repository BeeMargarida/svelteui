...
`,be="demo",ge={code:ke,toggle:!0},z=()=>{const a=()=>Math.trunc(Math.random()*5e5),t=Array(5e6).fill(void 0).map(a);return t.sort(),t.slice(0,5)};function we(a,t,r){let e,n,s="",f=0;const i=V(()=>r(2,f++,f)),{workerFn:c,workerStatus:l,workerTerminate:o}=ne(z),u=async()=>{r(0,n=null),await G(),r(0,n=z()),r(1,s="Main")},d=async()=>{r(0,n=null),await G(),r(0,n=await c()),r(1,s="Worker")};i.resume();const p=()=>o();return r(3,e=l==="RUNNING"),[n,s,f,e,o,u,d,p]}class de extends Y{constructor(t){super(),H(this,t,we,_e,J,{})}}const Ue=Object.freeze(Object.defineProperty({__proto__:null,configuration:ge,default:de,type:be},Symbol.toStringTag,{value:"Module"}));export{Ue as u};
